...
namespace GwambaPrimeAdventure.Character
{
	...
	internal sealed class GwambaDamager : StateController, IDestructible
	{
		...
		[field: SerializeField, BoxGroup("Statistics"), HideIf(nameof(_takeDamage)), Min(0F), Tooltip("The amount of time the attack screen shake will be applied.")] internal float AttackShakeTime { get; private set; }
