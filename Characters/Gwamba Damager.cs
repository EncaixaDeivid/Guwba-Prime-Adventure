...
namespace GwambaPrimeAdventure.Character
{
	...
	internal sealed class GwambaDamager : StateController, IDestructible
	{
		...
		[SerializeField, Min(0f), Tooltip("The amount of time the attack screen shake will be applied.")] private float _attackShakeTime;
		[SerializeField, Tooltip("The amount of damage that the attack of Guwba hits.")] private ushort _attackDamage;
		[SerializeField, Min(0f), Tooltip("The amount of time that this Guwba's attack stun does.")] private float _stunTime;
