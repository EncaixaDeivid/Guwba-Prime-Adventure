	...
	internal sealed class JumperEnemy : MovingEnemy, IConnector
	{
		...
		private void BasicJump(Vector2 target)
		{
			...
			IEnumerator Jump()
			{
				...
				{
					bool valid = !this.SurfacePerception() && this.isActiveAndEnabled && this.IsStunned && !this._stopJump;
		...
		private new void Awake()
		{
			...
			{
				bool valid = !this._detected && this.isActiveAndEnabled && this.IsStunned && !this._stopJump;
