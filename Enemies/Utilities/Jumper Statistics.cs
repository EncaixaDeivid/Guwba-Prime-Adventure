...
namespace GwambaPrimeAdventure.Enemy.Utility
{
	...
	public sealed class JumperStatistics : MovingStatistics
	{
		...
		[field: SerializeField, Tooltip("The other target to move to on jump.")] public Vector2 OtherTarget { get; private set; }
		...
		[field: SerializeField, Tooltip("If the react to damage jump will follow a target.")] public bool FollowReact { get; private set; }
		[field: SerializeField, Tooltip("If the react to damage jump will turn on the target.")] public bool TurnFollowReact { get; private set; }
		[field: SerializeField, Tooltip("If it will stop moving on react to damage.")] public bool StopMoveReact { get; private set; }
	};
	[System.Serializable]
