...
namespace GwambaPrimeAdventure.Enemy.Utility
{
	...
	public sealed class ShooterStatistics : ScriptableObject
	{
		...
		[field: SerializeField, HideIf(nameof(ShootInfinity)), ShowIf(nameof(Stop)), Min(WorldBuild.MINIMUM_TIME_SPACE_LIMIT), Tooltip("The amount of time to stop this enemy to move.\nRequires: Moving Enemy.")]
