...
namespace GwambaPrimeAdventure
{
	public static class WorldBuild
	{
		...
		public const int SYSTEM_MASK = 1 << 3;
		public const int UI_MASK = 1 << 5;
		public const int CHARACTER_MASK = 1 << 6;
		public const int SCENE_MASK = 1 << 7;
		public const int ITEM_MASK = 1 << 8;
		public const int ENEMY_MASK = 1 << 9;
		public const int BOSS_MASK = 1 << 10;
